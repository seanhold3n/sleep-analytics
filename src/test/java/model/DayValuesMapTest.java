...
public class DayValuesMapTest {
	...
	public void setUp() throws Exception {
		...
		System.out.println(testMap.toJSONArray());
	}
	...
	public void testToJSONArray() {
		...
		final String JSON_EXPECTED = "[[Date.UTC(2016,2,1),8.00],[Date.UTC(2016,2,2),6.50],[Date.UTC(2016,2,3),10.30],[Date.UTC(2016,2,4),7.35],[Date.UTC(2016,2,5),9.43]]";
